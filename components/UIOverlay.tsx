         ...
         <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div className="col-span-12 md:col-span-8">
               ...
               <div className="flex gap-4 mt-10">
                 <a href="https://github.com/shangobashi" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 bg-white text-black border border-white rounded-sm font-mono text-sm font-bold hover:bg-zinc-200 transition-all shadow-[0_0_15px_rgba(255,255,255,0.3)]">
